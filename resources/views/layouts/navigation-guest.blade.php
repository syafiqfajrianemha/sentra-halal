    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link-parent :href="'#'" :active="request()->routeIs('profile.*')">
                        <x-slot name="name">Profil</x-slot>
                        <x-slot name="children">
                            <a href="{{ route('profile.about') }}" class="{{ request()->routeIs('profile.about') ? 'text-blue-500 font-bold' : '' }}">Tentang Sentra Halal</a>
                            <a href="{{ route('profile.visionmission') }}" class="{{ request()->routeIs('profile.visionmission') ? 'text-blue-500 font-bold' : '' }}">Visi dan Misi</a>
                            <a href="{{ route('profile.organizationstructure') }}" class="{{ request()->routeIs('profile.organizationstructure') ? 'text-blue-500 font-bold' : '' }}">Struktur Organisasi</a>
                        </x-slot>
                    </x-nav-link-parent>
                </div>
