            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 flex flex-col md:flex-row items-center justify-between">
                    <div class="w-full md:w-1/2 mb-6 md:mb-0">
                        <h2 class="text-lg font-bold mb-4">PELATIHAN PENDAMPING PRODUK HALAL (PPH)</h2>
                        ...
                        <h3 class="text-md font-semibold mt-4">Total Jumlah Pendamping Halal Sentra Halal UMP : 244 orang</h3>
                    </div>

                    <div class="w-full md:w-1/2 flex justify-center md:justify-end">
                        <div class="w-100 h-100 md:w-100 md:h-100 bg-white flex items-center justify-center">
                            <img src="{{ asset('images/pph.jpg') }}" alt="Logo" class="max-w-full h-auto">
                        </div>
                    </div>
                </div>
            </div>
