            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 flex flex-col md:flex-row items-center justify-between">
                    <div class="w-full md:w-1/2 mb-6 md:mb-0">
                        ...
                        <h3 class="text-md font-semibold mt-4">Proses Pendirian Sentra Halal di Universitas Muhammadiyah Purwokerto:</h3>
                        <ul class="list-disc list-inside text-sm text-gray-700 text-justify">
                            <li>20 Maret 2016 - Tim Perumus</li>
                            <li>1 Agustus 2018 - SK tentang Pengurus Sentra Halal</li>
                            <li>12 Desember 2019 - Launching Sentra Halal</li>
                            <li>23 Maret 2020 - SK tentang Pengangkatan Ketua Pusat Studi di UMP</li>
                        </ul>
                    </div>
